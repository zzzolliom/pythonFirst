months_name = {1: 'jan', 2: 'feb', 3: 'march', 4: 'april', 5: 'may', 6: 'jun', 7: 'jul', 8: 'aug', 9: 'sep', 10: 'okt', 11: 'nov', 12: 'dec'}
...
if(year%4==0 and year%100!= 0 or year%400==0):
    ...
    print(months_name[n], quantity_days_in_month[n])

else:
    quantity_days_in_month = {1: 31, 2: 28, 3: 31, 4: 30, 5: 31,6: 30, 7: 31, 8: 31, 9: 30, 10: 31,11: 30, 12: 31}
    print(months_name[n], quantity_days_in_month[n],'days')
